...
const AdminSummary = () => {
    ...
    useEffect(()=>{
       const fetchSummary=async()=>{
         try {
             const summary=await axios.get('https://ems-backend-dun.vercel.app/api/dashboard/summary',{
                headers:{
    ...
    return (
        <div className="p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3 mt-6">
                <SummaryCard icon={<FaUsers />} text={"Total Employee"} number={summary.totalEmployees} color="bg-teal-600" />
